...
<div class="hero-wrap hero-bread" style="background-image: url('{{ asset('assets/front/images/bg_1.jpg') }}');">
  ...
  <section class="ftco-section">
    <div class="container">
     <form action="{{ route('front.order.place') }}" class="billing-form" method="post">
       {{-- action ta na dilau hoba --}}
              ...
              <div class="w-100"></div>
                  <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select name="country" id="" class="form-control">
                            ...
                            <option @if(old('country') == 'Chaina') selected @endif value="Chaina">Chaina</option>
                            <option @if(old('country') == 'Japan') selected @endif value="Japan">Japan</option>
                            <option @if(old('country') == 'Hongkong') selected @endif value="Hongkong">Hongkong</option>
                        </select>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input name="email" value="{{ old('email') }}" type="text" class="form-control" placeholder="">
                    ...
                    <div class="cart-detail p-3 p-md-4">
                        <h3 class="billing-heading mb-4">Payment Method</h3>
                                  <div class="form-group">
                                      <div class="col-md-12">
                                          <div class="radio">
                                             <label><input type="radio" name="payment_method" name="card" class="mr-2" value="card" @if(old('payment_method') == 'card') checked @endif>Card</label>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="radio">
                                             <label><input type="radio" name="payment_method" name="cod" class="mr-2" value="cod" @if(old('payment_method') == 'cod') checked @endif>Cash On Delivery</label>
                                          </div>
                                      </div>
