                      ...
                      <table class="table">
                          ...
                          <tbody>
                            ...
                            @if(session()->has('cart'))
                                ...
                                <tr class="text-center">
                                    <td class="product-remove"><a href="{{ route('remove.form.cart',$product_id) }}" onclick="return confirm('Are you confirm to remove this item for cart ?')"><span class="ion-ios-close"></span></a></td>
